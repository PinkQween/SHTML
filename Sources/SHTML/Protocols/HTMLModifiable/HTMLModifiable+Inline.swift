...
public extension HTMLModifiable {
    ...
    func borderLeft(width: CSSLength, style: BorderStyle = .solid, color: String) -> Self {
        appendingStyle("border-left: \(width.css) \(style.rawValue) \(color)")
    }
    ...
    func borderRight(width: CSSLength, style: BorderStyle = .solid, color: String) -> Self {
        appendingStyle("border-right: \(width.css) \(style.rawValue) \(color)")
    }
    ...
    func borderTop(width: CSSLength, style: BorderStyle = .solid, color: String) -> Self {
        appendingStyle("border-top: \(width.css) \(style.rawValue) \(color)")
    }
    ...
    func borderBottom(width: CSSLength, style: BorderStyle = .solid, color: String) -> Self {
        appendingStyle("border-bottom: \(width.css) \(style.rawValue) \(color)")
    }
